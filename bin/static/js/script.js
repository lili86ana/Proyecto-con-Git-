	...
	alert("Leyendo el script");
			...
			$("#boton").click(function() {
					...
					if (validacampos(arreglo)) {
							...
							document.getElementById("email").style.border = "5px solid #eee"; // poner el borde de color gris
							...
							console.log(JSON.stringify(jsonObj)); //imprime el objeto que se creo

							// configuracion de ajax para envio de datos
							var settings = {
								"async" : true, // es asincrono
								"crossDomain" : true, // politica de seguridad
								"url": "http://localhost:8080/agregarCliente", // url a donde se hara el request
